...
def generate_launch_description():
    ...
    default_model_path = os.path.join(pkg_share, 'models', 'sensors', 'camera_test.xacro')
    ...
    tf_link = Node(
        ...
        arguments = ['--x','0',
                        ...
                        '--yaw','0',
                        '--frame-id','lidar',
                        '--child-frame-id','camera_test/base_link/camera'],
        )
