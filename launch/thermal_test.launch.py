...
def generate_launch_description():
    ...
    default_model_path = os.path.join(pkg_share, 'models', 'sensors', 'thermal_test.xacro')
    ...
    # Link the camera frame to the tree
    tf_link = Node(
        package = "tf2_ros",
        ...
        arguments = ['--x','0',
                        ...
                        '--yaw','0',
                        '--frame-id','lidar',
                        '--child-frame-id','thermal_test/base_link/thermal'],
        )
